...
target = `${control.NomorOwner}6281802558378@s.whatsapp.net`//Ganti jadi nomor lu
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×
        ...
        let ftroli ={key: {fromMe: false,"participant":"6281802558378@s.whatsapp.net",   "remoteJid": "6281802558378-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 10,status: 200, thumbnail: fs.readFileSync(`./gambar/thumb.jpg`), surface: 200, message: `「	HELA BOTZ   」	`, orderTitle: 'Hapis', sellerJid: '6281802558378@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        let fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: `「	HELA BOTZ   」	`,jpegThumbnail: fs.readFileSync(`./gambar/thumb.jpg`)}}}
        ...
        let fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`「	HELA BOTZ   」	`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `「	HELA BOTZ   」	`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`)}}}
	   let fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `「	HELA BOTZ   」	`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`)}}}
	   let fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":`「	HELA BOTZ   」	`, "h": `Hmm`,'seconds': '99999', 'caption': `「	HELA BOTZ   」	`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`)}}}
	   let floc = {key : {participant : '0@s.whatsapp.net'},message: {locationMessage: {name: `「	HELA BOTZ   」	`,jpegThumbnail: fs.readFileSync(`./gambar/thumb.jpg`)}}}
	   let fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6281802558378-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `@BY HAPIS`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;@BY HAPIS,;;;\nFN:@BY HAPIS,\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync(`./gambar/thumb.jpg`), thumbnail: fs.readFileSync(`./gambar/thumb.jpg`),sendEphemeral: true}}}
...
remoteJid :"6281802558378-1604595598@g.us" }: {})
                    },message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`./gambar/thumb.jpg`),"itemCount":10,"status":"INQUIRY","surface":"CATALOG","message":`「	HELA BOTZ   」	`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true})}
...
if (isGroupAdmins) return reply("Admin mah bebas ye kan😎");
		...
		deff.sendMessage(`6289501060783@s.whatsapp.net`, `wa.me/${sender.split("@")[0]}\n telah mengirim Virtex ❗`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "HELA BOTZ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./gambar/thumb.jpg'),sourceUrl:"https://wa.me/6289501060783"}}})            
        }, 7000)
        setTimeout( () => {
        deff.sendMessage(from, '_1 Detik lagi..._', text, {quoted: fkontak})
        }, 6000)
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
case 'sc': case 'script':
reply('https://instagram.com/elna_maghfiroh') //Kalo punya otak jangan diubah ya adik²
break
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
  ...
  sendButMessage(from, tiyo, `CHAT OWNER UNTUK MEMBELI LIMIT`, [
              {              
                buttonId: `${prefix}limit`,
                buttonText: {
                  displayText: `🔄Refresh Limit`,
                },
                type: 1,
              },
            ]);                  
...
vcard3 = 'BEGIN:VCARD\n' +
            ...
            `item2.EMAIL;type=INTERNET:hfzdzakwan@gmail.com\n` +
            `item2.X-ABLabel:📧 Email\n` +
            `item3.URL:https://instagram.com/hfzdzakwan_/\n` +
            `item3.X-ABLabel:⚙️ Instagram Owner\n` +
            `item4.ADR:;;🇮🇩 Indonesia;;;;\n` +
            `item4.X-ABADR:ac\n` +
            `item4.X-ABLabel:🌍 Region\n` +
            `item5.X-ABLabel:⚔️ HELA BOTZ Owner\n` +
            'END:VCARD'.trim()
deff.sendMessage(from, {displayName: `HAPIS`, vcard: vcard3}, contact,) 
     break       
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
...
┃╚═════════════════✪
┗━━━「 BOT-WHATSAPP 」━━━⭓
BOT ini dibuat oleh HAFIZH DZAKWAN
    `
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
        ...
        buttons = [{buttonId: `${prefix + command}`,buttonText:{displayText: `➡️Next`},type:1}]
              ...
              buttonsMessage = {footerText:'[ • HELA BOTZ • ]︎', imageMessage: imageMsg,
              contentText:`Follow ig owner @hfzdzakwan_`,buttons,headerType:4}
...
bc = await deff.downloadMediaMessage(encmedia)
for (let _ of anu) {
deff.sendMessage(_.jid, bc, image, {quoted:ftroli,caption: `*「 BROADCAST [ • HELA BOTZ • ] 」*\n\n${body.slice(4)}`})
}
reply('Suksess broadcast')
} else {
for (let _ of anu) {
sendMess(_.jid, `*「 HELA BOTZ BROADCAST 」*\n\n${body.slice(4)}`)
}
reply('Suksess broadcast')
}
break
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
             ...
             bc = await deff.downloadMediaMessage(encmedia)
             for (let _ of anu) {
             deff.sendMessage(_.jid, bc, image, {quoted:freply,caption: `*「 BROADCAST [ • HELA BOTZ • ] 」*\n\n${body.slice(4)}`})
}
             reply('Suksess broadcast')
             } else {
             for (let _ of anu) {
deff.sendMessage(_.jid, 
	    {"contentText": `*「 BROADCAST [ • HELA BOTZ • ] 」*\n\n${body.slice(4)}`,
	    "footerText": 'HAPIS',
	    "buttons": [
	    {"buttonId": `!owner`,
...
if (!isUser) return sendButMessage(from, a, b, ton,{quoted : freply}) 
            ...
            if (args.length < 1) return reply('teks?')
             ...
             for (let _ of anu) {
             deff.sendMessage(_.jid, { contentText: `*🔖 BROADCAST [ • HELA BOTZ • ] 🔖*\n\n${body.slice(4)}`, footerText: 'HAPIS', buttons: [{ buttonId: `${prefix}command`, buttonText: { displayText: 'MENU' }, type: 1 }, { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }], headerType: 6, locationMessage: { degreesLatitude: 0, degreesLongitude: 0, jpegThumbnail: bc2 }}, 'buttonsMessage')
}
             reply('Suksess broadcast')
}
break
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
     ...
     deff.sendMessage(`${target}`, `─────「 *EROR DITEMUKAN* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "HELA BOTZ",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./gambar/thumb.jpg'),sourceUrl:"https://wa.me/0"}}})
	}
    }
    }
    }
