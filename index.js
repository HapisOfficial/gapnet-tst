...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
require('./Hapis.js')
nocache('./Hapis.js', module => console.log(`${module} is now updated!`))
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
...
const starts = async (deff = new WAConnection()) => {
    ...
    console.log(color(figlet.textSync('HAPIS', {
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
    deff.browserDescription = [ 'HAPIS SAYANG ELNA', 'Safari', '3.0.0' ]
    
    deff.on('qr', () => {
        console.log(color('[','white'), color('!','red'), color(']','white'), color(' Silahkan Scan '))
    })
...
console.log(' ====================================================')
console.log(color(' ===================================================='))
console.log(color('│ + Pembuat script : https://wa.me/6281802558378│ '))
console.log(color(' ===================================================='))
console.log(color('[ HAPIS ]', 'cyan'), color('Bot Sudah Online!'))
})
...
footerText: `No Developer : 081802558378` ,
buttons: buttonss,
headerType: 1
}
...
//=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×==×=×=×=×=×=×=×=×=×=×			
	/deff.on('group-update', async (anu) => {
    	...
    	const fkontakk = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(anu.jid ? { remoteJid: '6281802558378-1604595598@g.us' } : {})}, message: { "contactMessage":{"displayName": `${metdata.subject}`,"vcard":`BEGIN:VCARD\nVERSION:3.0\nN:2;deff;;;\nFN:deff\nitem1.TEL;waid=${control.NomorOwner}:${control.NomorOwner}\nitem1.X-ABLabel:Mobile\nEND:VCARD` }}}
...
function doProgress()
{
	...
	if ( progress >= 1 )
	{
		...
		exec(`screenfetch -A Deepin`, (error, stdout, stderr) => {
			console.log(stdout), console.log(bgcolor('https://github.com/gapnet-tst', 'cyan'))})}, 200 ) ;
	}
	else
	{
